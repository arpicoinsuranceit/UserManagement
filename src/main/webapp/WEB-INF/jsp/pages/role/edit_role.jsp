					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<form id="form_add_role">
								...
								<div class="form-group">
									<label>Description</label> <input type="text" id="roledescription"
		...
		<script type="text/javascript">
			...
			function getSystems(sbu) {
			 ...
			 function getSelectedRole(){
	        	...
	        	$.ajax({
					type : 'get',
					url : '${path}/role/getRoleID/${id}',
					success : function(resp) {
						console.log(resp);
						$('#roleName').val(resp.name);
						$('#roledescription').val(resp.description);
						$("#tbody_menu_add tr").remove();
						var html = "";
						if (resp != null) {
							for ( var i in resp.menuDto) {
								var item = resp.menuDto[i];
