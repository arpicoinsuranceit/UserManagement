...
@Entity
@Table(name = "SBU")
public class SbuModel implements Serializable {
	...
	private List<SubSbuModel> sbuModels;
	...
	@OneToMany(mappedBy = "sbu", targetEntity = SubSbuModel.class)
	public List<SubSbuModel> getSbuModels() {
		return sbuModels;
	}

	public void setSbuModels(List<SubSbuModel> sbuModels) {
		this.sbuModels = sbuModels;
	}
